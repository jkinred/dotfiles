...
IMPORTANT: Never start implementing without explicit approval.
After completing Phase 1, always ask me how I want to proceed
before writing any code. Offer these options:
...
- Before starting implementation, announce the progress file
  path that will be updated at session end.
